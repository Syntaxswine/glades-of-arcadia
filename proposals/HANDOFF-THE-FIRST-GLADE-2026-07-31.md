...
## FORWARD — the arc after this one

Everything above ends 2026-08-01. The next day's work has its own keystone:

> **`HANDOFF-THE-IMAGE-PACK-2026-08-02.md`** — the image pack redrawn for the
> projection, rotation-dependent art (ramps in four directions, hedges and
> fences that turn corners, gates set into the walls they belong to), and three
> more instruments.

Read this file for the shadow arc, the laws and the traps; read that one for
anything to do with which way an object faces or how two pieces meet.
